...
class ScriptGenerator:
    ...
    def _generate_story(self, topic: str, hook: str, hook_type: str, style: dict) -> dict:
        ...
        prompt = (
            ...
            "  'time': (e.g. T+0)\n"
            "  'lighting': (MUST use comic terms: 'High Contrast', 'Hard Ink Shadows', 'Vibrant Highlights', 'Rim Light', 'Flat Color')\n"
            "  'atmosphere': (e.g. Digital Gloom, Electric Tension)\n"
            "  'camera': (e.g. Extreme Close up, Dynamic Tilt)\n\n"
